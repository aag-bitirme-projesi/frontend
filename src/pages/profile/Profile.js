                ...
                <div className='w-2/3 pl-6'>
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="w-full pl-4">
                            ...
                            <input className="shadow appearance-none border rounded-xl w-full py-2 px-3 text-afafaf leading-tight focus:outline-none focus:shadow-outline"
                                id="surname" type="text" placeholder="Surname" name="surname" value={formData.surname} onChange={handleChange} />
                        </div>
                    </div>
                    <div className="flex justify-between items-center mb-6">
                        <div className="w-full pr-4">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="w-full pl-4">
                            ...
                            <input className="shadow appearance-none border rounded-xl w-full py-2 px-3 text-afafaf leading-tight focus:outline-none focus:shadow-outline"
                                id="cvLink" type="text" placeholder="CV Link" name="cvLink" value={formData.cvLink} onChange={handleChange} />
                        </div>
                    </div>
