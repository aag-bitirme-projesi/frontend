...
function Navbar() {
    ...
    const hiddenPaths = ['/signin', '/signup', '/','/hiddenpage', '/forgotPassword', '/contactUs','/changePassword'];
            ...
            <div className="w-full mx-auto ">
                <div className="flex justify-between items-center border-b-4 border-border-mavi ">
                    <div className="flex justify-start p-6">
                        ...
                        <a href='/FAQ' className="whitespace-nowrap text-base font-bold text-side-gri px-4">
                            FAQ
                        </a>
                    </div>
                    <div className="flex items-center justify-end flex-1 p-6 mr-8">
                        ...
                        <div className='flex items-center ml-4'>
                            <button className="rounded-full bg-center bg-cover inline-block w-12 h-12 " onClick = {handleProfile} style={{ backgroundImage: `url(${profile.imageUrl})` }}></button>
                            <button  onClick = {handleProfile} className="ml-4 whitespace-nowrap inline-flex items-center justify-center text-lg font-black text-white">
                                {profile.name}
                            </button>
                        </div>
                    </div>
