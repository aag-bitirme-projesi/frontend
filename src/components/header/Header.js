...
const Header = () => {
    ...
    const hiddenPaths = ['/signin', '/signup', '/output', '/card', '/dashboard', '/contact', '/profile', '/wallet', '/run', '/models', '/datasets', '/hiddenpage', '/forgotPassword', '/landingPage', '/FAQ', '/contactUs', ,'/changePassword'];
